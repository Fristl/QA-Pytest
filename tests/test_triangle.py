...
def test_triangle_area_positive(cache, side_a, side_b, side_c, area):
...
def test_triangle_negative(cache, side_a, side_b, side_c):
...
def test_triangle_not_exist(cache, side_a, side_b, side_c):
...
def test_triangle_perimeter_positive(cache, side_a, side_b, side_c, perimeter):
    triangle = Triangle(side_a, side_b, side_c)
    assert triangle.perimeter == perimeter,\
        f"Triangle perimeter with sides {side_a}, {side_b}, {side_c} must be {perimeter}"
